defmodule Mementho.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{email: "email@gmail.com", password: "some password", username: "some username"}
    @update_attrs %{email: "someemail@gmail.com", password: "some updated password", username: "some updated username"}
